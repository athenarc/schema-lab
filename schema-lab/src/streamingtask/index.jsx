...
import StreamingTaskForm from "./StreamingTaskForm";
  ...
  return (
    <div className="d-flex flex-column min-vh-100">
      <Container className="flex-grow-1">
        <Row>
          <Col>
            <h1 className="display-6 mb-4">Setup a Streaming Task</h1>
            <p className="display-7">
              Submit streaming task for project: <strong>{projectName}</strong>.
            </p>
            <Container>
              <StreamingTaskForm />
            </Container>
...
export default RunStreamingTask;
